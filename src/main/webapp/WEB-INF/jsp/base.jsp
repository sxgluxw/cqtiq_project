     ...
     <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index"><strong>首页</strong></a>
<div id="sideNav" href=""><i class="fa fa-caret-right"></i></div>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        <li>
                            <a href="#">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small">4 分钟</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-twitter fa-fw"></i> 3个新用户
                                    <span class="pull-right text-muted small">12 分钟</span>
                                </div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-envelope fa-fw"></i> 发送信息
                                    <span class="pull-right text-muted small">4 分钟</span>
                                </div>
                            </a>
                        </li>
        ...
        $(".a_post").on("click",function(){
            ...
            $.ajax({
                   type: "POST",
                   url: "http://localhost:8080/cqtiq/switch/exit",
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="chart"><i class="fa fa-bar-chart-o"></i> 图表</a>
                    </li>
                    <li>
